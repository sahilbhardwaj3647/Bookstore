...
function Navbar() {
  ...
  const navItems = (
    <>
      ...
      <li>
        <a href='/course' className="dark:text-white">Course</a>
      </li>
      <li>
        <button onClick={() => document.getElementById('contact_modal').showModal()} className="dark:text-white cursor-pointer">
          Contact
        </button>
      </li>
      <li>
